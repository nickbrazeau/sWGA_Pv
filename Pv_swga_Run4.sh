...
# For "Pf":
swga init --fg_genome_fp PlasmoDB-13.0_PvivaxSal1_Genome_NOAAKM.fasta --bg_genome_fp GRCh38p7_genomic.fasta --exclude_fp PlasmoDB-13.0_Pfalciparum3D7_Genome.fasta
...
# For "Pv" set:
swga count --exclude_threshold 20
...
swga filter --max_tm 60 --min_tm 18 --max_gini 0.6
###########################
